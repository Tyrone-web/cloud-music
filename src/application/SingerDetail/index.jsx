...
import { ImgWrapper, CollectButton, BgLayer, SongListWrapper } from "./style";
...
const SingerDetail = (props) => {
  ...
  const artist = useSelector((state) =>
    state.getIn(["singerDetail", "artist"])
  );
  const songsOfArtist = useSelector((state) =>
    state.getIn(["singerDetail", "songsOfArtist"])
  );
  const loading = useSelector((state) =>
    state.getIn(["singerDetail", "loading"])
  );
